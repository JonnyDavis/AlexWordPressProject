...
class Illdy {
	...
	public function remove_specific_widget( $sidebars_widgets ) {
		...
		$front_page_sidebars = array( 'front-page-about-sidebar', 'front-page-products-sidebar', 'front-page-projects-sidebar', 'front-page-services-sidebar', 'front-page-counter-sidebar', 'front-page-team-sidebar', 'front-page-full-width-sidebar', 'front-page-testimonials-sidebar' );
