...
if ( ! function_exists( 'illdy_customize_register' ) ) {
	function illdy_customize_register( $wp_customize ) {
		...
		// Products
		require_once get_template_directory() . '/inc/customizer/panels/products.php';
...
if ( ! function_exists( 'illdy_products_general_title' ) ) {
	function illdy_products_general_title() {
		return get_theme_mode( 'illdy_products_general_title' );
	}
}

if ( ! function_exists( 'illdy_products_general_entry' ) ) {
	function illdy_products_general_entry() {
		return get_theme_mode( 'illdy_products_general_entry' );
	}
}
...
function illdy_print_customizer_templates() {
	...
	<script id="illdy-products-section" type="text/x-handlebars-template">
		{{#if illdy_products_general_image }}
			#products:before { background-image: url({{illdy_products_general_image}}) !important; }
		{{/if}}
		{{#if illdy_products_background_position_y }}
			#products:before { background-position-y: {{illdy_products_background_position_y}} !important; }
		{{/if}}
		{{#if illdy_products_background_position_x }}
			#products:before { background-position-x: {{illdy_products_background_position_x}} !important; }
		{{/if}}
		{{#if illdy_products_background_attachment }}
			#products:before { background-attachment: scroll !important; }
		{{/if}}
		{{#if illdy_products_background_repeat }}
			#products:before { background-repeat: repeat !important; }
		{{/if}}
		{{#if illdy_products_background_size }}
			#products:before { background-size: {{illdy_products_background_size}} !important; }
		{{/if}}
		{{#if illdy_products_general_color }}
			#products:before { background-color: {{illdy_products_general_color}}; }
		{{/if}}
		{{#if  illdy_products_title_color }}
			#products .section-header h3 { color: {{illdy_products_title_color}}; }
		{{/if}}
		{{#if  illdy_products_descriptions_color }}
			#products .section-header .section-description { color: {{illdy_products_descriptions_color}}; }
		{{/if}}
	</script>	
