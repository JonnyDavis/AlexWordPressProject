...
( function( api ) {
    var sections = [ 'illdy_jumbotron_general', 'illdy_panel_about', 'illdy_panel_products', 'illdy_panel_projects', 'illdy_testimonials_general', 'illdy_panel_services', 'illdy_latest_news_general', 'illdy_counter_general', 'illdy_panel_team', 'illdy_contact_us', 'illdy_full_width' ];
...
(function ($) {
		...
		$('.add-new-widget').on('click', function (event) {
			...
			switch ( id ) {
				...
				case 'customize-control-sidebars_widgets-front-page-about-sidebar':
					...
					break;
                case 'customize-control-sidebars_widgets-front-page-products-sidebar':
                    $.each(widgetList, function ($k, $v) {
                        var individualId = $(this).attr('data-widget-id');
                        if ( individualId.search('illdy_skill') == -1 ) {
                            $(this).hide();
    ...
    var sections = {
        ...
        'products' : [
            'illdy_products_title_color',
            'illdy_products_descriptions_color',
            'illdy_products_general_color',
            'illdy_products_general_image',
            'illdy_products_background_size',
            'illdy_products_background_repeat',
            'illdy_products_background_attachment',
            'illdy_products_background_position_y',
            'illdy_products_background_position_x'
        ],
        'projects' : [
    ...
    function update_products_css(){
        var liveObj = {
            'action' : 'illdy_generate_section_css',
            'illdy_section' : 'products',
            'values' : {}
        };

         _.each( sections.products, function( setting ){
            liveObj.values[setting] = wp.customize(setting)();
        });
                ...
                _.each( sections, function( settings, section_ID  ){
                    _.each( settings, function( setting ){
                        wp.customize(setting, function (setting) {
                            ...
                            }else if ( section_ID == 'products' ) {
                                setting.bind(update_products_css);
