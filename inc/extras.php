...
if ( ! function_exists( 'illdy_sections_show' ) ) {
	function illdy_sections_order( $section ) {
		...
		$controls = array(
			...
			'illdy_panel_products' => 'illdy_products_general_show',
...
if ( ! function_exists( 'illdy_products_css' ) ) {
	function illdy_products_css() {

		$illdy_products_title_color = get_theme_mod( 'illdy_products_title_color' );
		$illdy_products_descriptions_color = get_theme_mod( 'illdy_products_descriptions_color' );
		$illdy_products_general_color = get_theme_mod( 'illdy_products_general_color' );
		$illdy_products_general_image = get_theme_mod( 'illdy_products_general_image' );
		$illdy_products_background_size = get_theme_mod( 'illdy_products_background_size' );
		$illdy_products_background_repeat = get_theme_mod( 'illdy_products_background_repeat' );
		$illdy_products_background_attachment = get_theme_mod( 'illdy_products_background_attachment' );
		$illdy_products_background_position_y = get_theme_mod( 'illdy_products_background_position_y' );
		$illdy_products_background_position_x = get_theme_mod( 'illdy_products_background_position_x' );

		$css = '';
		if ( $illdy_products_general_image ) {
			$css .= '#products:before {background-image: url(' . esc_url( $illdy_products_general_image ) . ') !important;}';
		}
		if ( $illdy_products_background_position_y ) {
			$css .= '#products:before {background-position-y: ' . esc_attr( $illdy_products_background_position_y ) . ';}';
		}
		if ( $illdy_products_background_position_x ) {
			$css .= '#products:before {background-position-x: ' . esc_attr( $illdy_products_background_position_x ) . ';}';
		}
		if ( $illdy_products_background_size ) {
			$css .= '#products:before {background-size: ' . esc_attr( $illdy_products_background_size ) . ' !important;}';
		}
		if ( $illdy_products_background_repeat ) {
			$css .= '#products:before {background-repeat: repeat !important;}';
		}
		if ( $illdy_products_background_attachment ) {
			$css .= '#products:before {background-attachment: scroll !important;}';
		}
		if ( $illdy_products_general_color ) {
			$css .= '#products:before {background-color: ' . esc_attr( $illdy_products_general_color ) . ';}';
		}
		if ( $illdy_products_title_color ) {
			$css .= '#products .section-header h3 {color: ' . esc_attr( $illdy_products_title_color ) . ';}';
		}
		if ( $illdy_products_descriptions_color ) {
			$css .= '#products .section-header .section-description {color: ' . esc_attr( $illdy_products_descriptions_color ) . ';}';
		}
