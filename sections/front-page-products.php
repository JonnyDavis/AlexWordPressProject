<?php
/**
 *  The template for displaying products section in front page.
 *
 *  @package WordPress
 *  @subpackage illdy
 */
...
if ( current_user_can( 'edit_theme_options' ) ) {
	$general_title = get_theme_mod( 'illdy_products_general_title', __( 'Products', 'illdy' ) );
	$general_entry = get_theme_mod( 'illdy_products_general_entry', __( 'It is an amazing one-page theme with great features that offers an incredible experience. It is easy to install, make changes, adapt for your business. A modern design with clean lines and styling for a wide variety of content, exactly how a business design should be. You can add as many images as you want to the main header area and turn them into slider.', 'illdy' ) );
} else {
	$general_title = get_theme_mod( 'illdy_products_general_title' );
	$general_entry = get_theme_mod( 'illdy_products_general_entry' );
}
?>

<?php if ( '' != $general_title || '' != $general_entry || is_active_sidebar( 'front-page-products-sidebar' ) ) { ?>

<section id="products" class="front-page-section" style="<?php if ( ! $general_title && ! $general_entry ) : echo 'padding-top: 130px;';
endif; ?>">
	...
	<div class="section-content">
		<div class="container">
			<div class="row">
				<?php
				if ( is_active_sidebar( 'front-page-products-sidebar' ) ) :
					dynamic_sidebar( 'front-page-products-sidebar' );
...
</section><!--/#products.front-page-section-->
